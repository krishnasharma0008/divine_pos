class ProductModel {
  ...
  final String?
  mountDetails1; // For display: "MetalType MetalPurity MetalColor MetalWeight"
  ...
  const ProductModel({
    ...
    this.mountDetails1, // For display: "MetalType MetalPurity MetalColor MetalWeight"
    this.metalType,
    this.metalPurity,
    this.metalColor,
    this.metalWeight,
  ...
  ProductModel copyWith({
    ...
    Object? mountDetails1 =
        _unset, // For display: "MetalType MetalPurity MetalColor MetalWeight"
    ...
    return ProductModel(
      ...
      mountDetails1: mountDetails1 == _unset
          ? this.mountDetails1
          : mountDetails1
                as String?, // For display: "MetalType MetalPurity MetalColor MetalWeight"
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) {
    ...
    return ProductModel(
      ...
      mountDetails1: str(json['mount_details1']),
