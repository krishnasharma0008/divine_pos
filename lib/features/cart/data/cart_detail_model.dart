class CartDetail {
  ...
  factory CartDetail.fromJson(Map<String, dynamic> json) {
    final remarks = json['cart_remarks'] as String?;
    return CartDetail(
      id: json['id'] as int?,
  ...
  CartDetail copyWith({
    ...
    return CartDetail(
      ...
      solitairePremSize: solitairePremSize,
      solitairePremPct: solitairePremPct,
      solitaireAmtMin: solitaireAmtMin,
      solitaireAmtMax: solitaireAmtMax,
      metalType: metalType,
      metalPurity: metalPurity,
      metalColor: metalColor,
      metalWeight: metalWeight,
      metalPrice: metalPrice,
      mountAmtMin: mountAmtMin,
      mountAmtMax: mountAmtMax,
      sizeFrom: sizeFrom,
      sizeTo: sizeTo,
      sideStonePcs: sideStonePcs,
      sideStoneCts: sideStoneCts,
      sideStoneColor: sideStoneColor,
      sideStoneQuality: sideStoneQuality,
      ...
      gender: gender,
      //engravingEnabled: engravingEnabled ?? this.engravingEnabled,
    );
  }
